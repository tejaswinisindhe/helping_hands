    ...
    <footer className="bg-background border-t border-border">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">EchoMate</span>
            </Link>
            <p className="text-sm text-muted-foreground">
              Connecting passionate volunteers with impactful opportunities to create positive change.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/volunteers" className="text-muted-foreground hover:text-foreground">
                  For Volunteers
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} EchoMate. All rights reserved.
          </p>
